  ...
  return (
    <main className="max-w-[600px] m-auto px-1 py-3">
      ...
      <section className="bg-body-50 p-1.5 rounded-xl mb-2">
        ...
        <ul>
          <li className="mb-0.75">福利厚生システム　バックオフィス（Webデザイン, バックエンド）</li>
          <li className="mb-0.75">社内教育システム　Webアプリ化・プッシュ通知対応（フロントエンド, バックエンド）</li>
          <li className="mb-0.75">ふるさと納税サービス　寄付決済画面・バックオフィス（Webデザイン, フロントエンド）</li>
          <li className="mb-0.75">
            インスタントウィン・アンケートキャンペーンシステム　ユーザ画面・バックオフィス（Webデザイン,
            フロントエンド）
          </li>
          <li className="mb-0.75">医療関連サービス　受発注・検体管理画面（フロントエンド）</li>
          <li className="mb-0.75">採用・人事労災・福利厚生ツール（フロントエンド）</li>
          <li className="mb-0.75">出版社公式Webコミック配信サービス （Webデザイン, フロントエンド, バックエンド）</li>
          <li className="mb-0.75">出版社公式書籍紹介サイト （Webデザイン, フロントエンド, バックエンド）</li>
          <li className="mb-0.75">
